...
\begin{frame}{Files}
  \begin{center}
    A \textbf{file} is a collection of bytes united under one name.\\
...
\begin{frame}{RIFF}
  ...
  \begin{figure}
    \begin{bytefield}{16}
      ...
      \begin{leftwordgroup}[curlyspace=0.5em]{Chunk}
        \wordbox[lrt]{4}{
          \chunkbox \\
          \adjustbox{lap={\width}{1em}}{\wordbox{2}{Data}}
        } \\
        \wordbox[lr]{1}{\adjustbox{lap={\width}{1em}}{\Huge $\vdots$}} \\
        % \skippedwords\\
        \wordbox[lrb]{4}{
          \chunkbox \\
          \adjustbox{lap={\width}{1em}}{\wordbox{2}{Data}}
...
\begin{frame}{RIFF}
  \begin{center}
    \huge In a RIFF file, the chunk IDs are often the only plain-text strings in the file.
  \end{center}\pause
